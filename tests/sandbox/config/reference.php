 ...
 * }
 * @psalm-type CaptjmImageBrowserConfig = array{
 *     uploads_dir?: scalar|Param|null, // Absolute path to the uploads directory. Defaults to %kernel.project_dir%/public/uploads. // Default: "%kernel.project_dir%/public/uploads"
 *     uploads_web_path?: scalar|Param|null, // Public URL prefix for uploaded files (no trailing slash). // Default: "/uploads"
 *     allowed_extensions?: list<scalar|Param|null>,
 *     max_file_size?: int|Param, // Maximum upload size in bytes. Default: 5 MB. // Default: 5242880
 *     cif_dist_url?: scalar|Param|null, // URL to the compiled CIF Manager JS file (dist/editor.js from captjm/ckeditor-five-editor). Example: "/build/cif/editor.js" or a CDN URL. The script must be loadable from the browser.
 * }
 ...
 *     captjm_image_browser?: CaptjmImageBrowserConfig,
